...
public class rentingTransactionController {
    ...
    @FXML private ComboBox<Integer> cmbCustomerID;
    @FXML private ComboBox<Integer> cmbBikeID;
    @FXML private ComboBox<Integer> cmbBranchID;
    @FXML private DatePicker dateStart;
    @FXML private DatePicker dateEnd;
    @FXML private ComboBox<String> cmbRentalType; // Hourly or Daily
    @FXML private Label lblBikeModel;
    @FXML private Label lblRate;
    @FXML private Label lblTotalAmount;
    @FXML private Label lblMessage;
    @FXML private Button btnProcessRental;
    ...
    private void setupComboBoxes() {
        ...
        customerDAO.getAllCustomers().forEach(c -> 
            cmbCustomerID.getItems().add(c.getCustomerAccID())
        );
        
        // Load branches
        branchDAO.getAllBranches().forEach(b -> 
            cmbBranchID.getItems().add(b.getBranchID())
        );
    ...
    private void loadAvailableBikes() {
        ...
        if (cmbBranchID.getValue() == null) return;
